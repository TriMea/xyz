...
public class OTA_RetrieveBookRQ {
	...
	public String toString() {
		return "OTA_RetrieveBookRQ [checkIn=" + checkIn + ", checkOut="
				+ checkOut + ", contactName=" + contactName + ", contactTel="
				+ contactTel + ", dailyInfos=" + dailyInfos
				+ ", guaranteetype=" + guaranteetype + ", guestnum=" + guestnum
				+ ", hotelid=" + hotelid + ", latestarrivetime="
				+ latestarrivetime + ", mkt=" + mkt + ", orderGuests="
				+ orderGuests + ", paymentType=" + paymentType + ", pmsresid="
