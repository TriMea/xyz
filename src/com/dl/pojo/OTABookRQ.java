...
public class OTABookRQ {
	...
	public String toString() {
		return "OTABookRQ [checkIn=" + checkIn + ", checkOut=" + checkOut
				...
				+ orderType + ", paymentType=" + paymentType
				+ ", ratePlanCode=" + ratePlanCode + ", remark=" + remark
				+ ", roomNum=" + roomNum + ", roomTypeId=" + roomTypeId
				+ ", taoBaoOrderId=" + taoBaoOrderId + ", totalPrice="
				+ totalPrice + "]";
	}
